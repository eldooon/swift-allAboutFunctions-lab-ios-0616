 ...
 */
// write your code here
func favoriteCharacter (favChar: String){
    print ("My favorite character is \(favChar).")
}
...
let favorite = "Rick Sanchez"
favoriteCharacter(favorite)
//We cannot change value of a constant only variable
var favoriteVar = "Morty"
favoriteCharacter(favoriteVar)
 ...
 */
// write your code here
func nintyNineProblems (number : Int) {
    print ("I got \(number) problems but Swift ain't one.")
}

nintyNineProblems(99)
...
madLib("Buzz Lightyear", noun: "infinity", preposition: "beyond")
...
print(infinityBeyond("Buzz Lightyear"))
